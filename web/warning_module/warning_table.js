...
function initDatatable(isOrdered){
    $('.datatable').dataTable( {
        ...
        "sAjaxSource": isOrdered?"../ServletAction?Action=showWarningTable&isOrdered=true":"../ServletAction?Action=showWarningTable&isOrdered=false"
    });
...
function submitQueryRecord(){
    $('.datatable').dataTable( {
        ...
        "fnDrawCallback": function(){$(".checkboxes").uniform();$(".group-checkable").uniform();},
        //"sAjaxSource": "get_record.jsp"
        "sAjaxSource": "../ServletAction?Action=queryWarningRecord&warning_record="+$("#QueryWarningRecord #query_warning_record").val()+"&greenhouse_id="+$("#QueryWarningRecord #query_greenhouse_id").val(),
    });
    $('.datatable').find('.group-checkable').change(function () {
        var set = jQuery(this).attr("data-set");
        var checked = jQuery(this).is(":checked");
