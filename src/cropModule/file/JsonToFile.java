...
public class JsonToFile {
    // 定义导出的路径信息
    final String txtPath="C:\\Users\\78223\\Desktop\\export.txt";
    final String excelPath="C:\\Users\\78223\\Desktop\\export.xls";
    ...
    public JSONObject setJsonTOTxt(JSONObject jsonObject) throws JSONException, IOException {
        ...
        json.put("txtDownloadPath","/export.txt");
        return json;
    }
    ...
    public void setJsonToExcel(JSONObject json,JSONObject jsonObject) throws IOException, JSONException {
        ...
        outputStream.flush();
        outputStream.close();
        jsonObject.put("excelDownloadPath","/export.xls");
